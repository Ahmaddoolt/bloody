...
import '../../../../admin/inventory/presentation/screens/center_inventory_screen.dart';
...
class CenterCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bool isAssignedManager =
        currentUserId != null && center['admin_id'] == currentUserId;
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors: [
                            ...
                            AppTheme.darkRed.withOpacity(0.08),
                          ],
                      ...
                      child: canManage
                          ? _ActionButton(
                              ...
                              onPressed: () => Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (_) => CenterInventoryScreen(
                                          center: center))),
                            )
                          : _ActionButton(
                              label: 'view_stock'.tr(),
