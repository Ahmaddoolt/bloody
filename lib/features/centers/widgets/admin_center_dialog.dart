...
class _AdminCenterDialogState extends State<AdminCenterDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      title:
          Text(widget.center == null ? 'add_center'.tr() : 'edit_center'.tr()),
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration:
                      _inputDeco(context, 'phone_number'.tr(), Icons.phone),
                ),
                ...
                TextFormField(
                  ...
                  decoration:
                      _inputDeco(context, 'manager_email'.tr(), Icons.security)
                          .copyWith(
