...
class _SignupScreenState extends State<SignupScreen> {
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text("donor_rules_intro".tr(), style: const TextStyle(fontWeight: FontWeight.bold)),
        ...
        actions: [
          TextButton(
            ...
            child: FittedBox(
              child: Text("do_not_qualify".tr(), style: const TextStyle(color: Colors.grey)),
            ),
          ),
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  obscureText: true,
                  validator: (val) {
                    if (val == null || val.length < 6) return 'password_error'.tr();
                    return null;
                  },
                  decoration: InputDecoration(
  ...
  Widget _buildTypeCard(
    ...
    final bgColor =
        isSelected ? AppTheme.primaryRed : (isDark ? const Color(0xFF2C2C2C) : Colors.white);
    final borderColor =
        isSelected ? AppTheme.primaryRed : (isDark ? Colors.grey.shade700 : Colors.grey.shade300);
    final textColor =
        isSelected ? Colors.white : (isDark ? Colors.grey.shade400 : Colors.grey.shade700);
    final iconColor = isSelected ? Colors.white : (isDark ? Colors.grey.shade500 : Colors.grey);
